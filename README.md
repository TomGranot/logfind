...
3. In the original exercise, .logfind is suppose to be a file - like the one here - with possible extensions to allow. My version does not support that - it searches through all possible files.
